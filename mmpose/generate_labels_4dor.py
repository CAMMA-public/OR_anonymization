...
def remove_redundant_results(kpts, kpts_scores, boxes, kpts_score_threshold):
    ...
    pseudo_face_height = 80
    pseudo_face_width = 80
...
def generate_coco_annotations():
    ...
    """
    video_ids = [1, 3, 4, 5, 7, 8, 9, 10]
    OUTPUT_JSON_PATH = "4dor_kpts_full.json"
    ...
    for video_id in video_ids:
        pred_path = f'/home2020/home/icube/keqichen/code/4D-OR/datasets/4D-OR/face/export_holistic_take{video_id}_processed_deim_face.lmdb'
        root_dir = f'/home2020/home/icube/keqichen/datasets/4D-OR/export_holistic_take{video_id}_processed'
        save_dir = f'export_holistic_take{video_id}_processed'
        ...
        demo_img_path = os.path.join(root_dir, 'colorimage', img_dicts[0][0])
        ...
        with env.begin() as txn:
            ...
            for f_id in range(frame_num):
                for c_id in range(cam_num):
                    ...
                    img_path = os.path.join(root_dir, 'colorimage', img_key)
                    ...
                    image_info = {
                        "id": image_id_counter,
                        "file_name": os.path.join(save_dir, img_key),
                        "width": width,
                        "height": height
                    }
                    coco_output["images"].append(image_info)
                    
                    old_path = os.path.join(root_dir, 'colorimage', img_key)
                    new_path = os.path.join('/home2020/home/icube/keqichen/datasets/CrowdHuman/Images', save_dir, img_key)
