...
def main():
    ...
    parser.add_argument(
        "--path", default="/media/camma-monitor/Storage_postprocessing2/pose_detection/mva/006_RS_JPG_iter1_mva_tracking_bi.lmdb", type=str, help="path to detections"
    )
    parser.add_argument(
    ...
    with env.begin() as txn:
        ...
        for c_id, sub_dir in enumerate(sub_dirs):
            ...
            img_names.sort()
            for img_name in tqdm(img_names, desc=f"Processing {sub_dir}"):
                # if img_name != 'color-00012413.jpg':
                #     continue
