        ...
        for img_key, annos in gt.items():
            ...
            for anno in annos:
                ...
                if len(face_kpts):
                    ...
                    mv_gt_face_boxes_dict[mv_img_key][idx][cam_name] = face_box
                else:
                    boxes_face_vis[-1] = False
                ...
                if len(eyes_kpts):
                    ...
                    mv_gt_eyes_boxes_dict[mv_img_key][idx][cam_name] = eyes_box
                else:
                    boxes_eyes_vis[-1] = False
                ...
                if boxes_data is not None:
                    ...
                    if len(gt_face_boxes):
                        ...
                        for i, box in enumerate(boxes):
                            ...
                            if max_iou >= 0.3:# and best_match not in matched_gt:
                                face_mask[i] = True
                                matched_gt.add(best_match)
                        ...
                        if len(face_boxes):
                            ...
                            if len(face_boxes):
                                ...
                                mv_pred_face_boxes_dict[mv_img_key][cam_name] = [face_boxes, face_scores]
                    ...
                    if len(gt_eyes_boxes):
                        ...
                        if len(eyes_boxes):
                            ...
                            if len(eyes_boxes):
                                ...
                                mv_pred_eyes_boxes_dict[mv_img_key][cam_name] = [eyes_boxes, eyes_scores]
        env.close()
